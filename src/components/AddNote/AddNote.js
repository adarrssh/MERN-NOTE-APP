            ...
            <div className="card">
                <div className="card-body">
                    ...
                    <div className="mb-3">
                        ...
                        <button type="submit" onClick={handleClick} className="btn btn-outline-light   my-3">Submit</button>
                        <button onClick={() => { Navigate('/notes') }} className="btn btn-outline-light mx-3 my-3">Close</button>
